...
CREATE UNIQUE INDEX IF NOT EXISTS uq_category_mappings_source
ON category_mappings(source_category COLLATE NOCASE, COALESCE(source, ''));

CREATE INDEX IF NOT EXISTS idx_category_mappings_lookup
ON category_mappings(source_category COLLATE NOCASE, source, is_enabled);
