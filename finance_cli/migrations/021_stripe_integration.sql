...
DROP INDEX IF EXISTS idx_txn_stripe_txn_id;
...
CREATE TABLE transactions_new (
    ...
    notes                 TEXT,
    source                TEXT NOT NULL CHECK (source IN ('plaid', 'csv_import', 'manual', 'pdf_import', 'stripe')),
    raw_plaid_json        TEXT,
    split_group_id        TEXT,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_txn_stripe_txn_id
    ON transactions(stripe_txn_id)
